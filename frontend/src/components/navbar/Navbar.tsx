...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="flex justify-between items-center bg-white dark:bg-gray-800 transition-colors duration-300 px-8 py-3 shadow-md">
      <h1 className="text-xl text-gray-800 font-semibold cursor-pointer dark:text-white" onClick={()=>navigate({ pathname: '/' })}>Siftly</h1>
      <div className="flex items-center flex-grow mx-4">
        <div className="flex items-center w-full max-w-md mx-auto">
          <div className="relative w-full dark:color-white">
            <input
      ...
      <ul className="flex items-center justify-center space-x-6">
        <li className="font-semibold text-gray-700 hover:underline cursor-pointer dark:text-white" onClick={() => navigate({ pathname: '/auth' })}>Login/Sign Up</li>
